...
import { faArrowAltCircleDown, faArrowDown, faBuilding, faCalendarAlt, faPeopleArrowsLeftRight, faTag, faUsers } from "@fortawesome/free-solid-svg-icons";
...
const QuickResponseInfo = () => {
  ...
  if (!item) return <p className="text-center mt-10 text-red-500">Discussion paper not found.</p>;

  return (
<>
  <div className="bg-primary text-white py-10">
    <div className="container px-4 mx-auto">
      <h2 className="text-2xl font-bold font-avenir">Discussion Paper</h2>
    </div>
  </div>
    ...
    <div className="grid md:grid-cols-2 gap-6">
      ...
      <div className="py-6">
        <p className="text-sm text-gray-600 my-2">
          <span className="mr-2"><FontAwesomeIcon icon={faCalendarAlt}/></span>
          <strong>Publication Year:</strong>  {item.year}
        </p>

        <p className="text-sm text-gray-700 my-2">
          <span className="mr-1"><FontAwesomeIcon icon={faUsers}/></span>
          <strong>Author(s):</strong> {item.Authors}
        </p>

        <p className="text-sm text-gray-700 my-2">
          <span className="mr-1"><FontAwesomeIcon icon={faBuilding}/></span>
          <strong>Institution:</strong> {item.Institution}
        </p>

        <p className="text-sm text-gray-700 my-2">
          <span className="mr-1"><FontAwesomeIcon icon={faTag}/></span>
